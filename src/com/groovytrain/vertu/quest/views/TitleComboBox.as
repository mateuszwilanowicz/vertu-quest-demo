package com.groovytrain.vertu.quest.views {
	 ...
	 * @author mateuszw
	 */
	public class TitleComboBox extends Sprite {
		...
		private function drawFirstRow() : void {
			...
			var arrow : Sprite;
			if(_titleRow == null) {
				rowSprite = new WtbComboRowSprite("title");
		...
		private function openDropDown() : void {
			...
			TweenLite.to(_maskSprite, 1, {height:100, y:_rowDepth});
		}
...
//				trace("mouseY::" + mouseY + " ||| " + "mouseY::" + mouseY);// 40 - 350
				...
				var minY : Number = _rowDepth - _consealedSprite.height + 100;
		...
		public function addRow(rowModel : AbstractModel) : void {
			var rowSprite : WtbComboRowSprite = new WtbComboRowSprite("title");
